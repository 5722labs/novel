  ...
  return (
    <Popover.Root open={isOpen}>
      <div className="novel-relative novel-h-full">
        ...
        >
          <div className="novel-my-1 novel-px-2 novel-text-sm novel-text-stone-500">Color</div>
          ...
          <div className="novel-mb-1 novel-mt-2 novel-px-2 novel-text-sm novel-text-stone-500">Background</div>
